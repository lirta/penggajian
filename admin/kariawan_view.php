                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        <?php
                        $queri = mysqli_query($koneksi, "SELECT * FROM pegawai  where kategori='KARIAWAN'");
                        ...
                        ?>
                          <tr>
                            ...
                            <td>
                              <?php echo "
                  <a href='kariawan_hapus.php?id=$kolom[id_pegawai]' onclick=\"return confirm('Apakah anda yakin akan menghapus :)\" class='btn btn-danger btn-sm'>Hapus</a> <br><br>
                  <a href='kariawan_edit.php?id=$kolom[id_pegawai]' class='btn btn-warning btn-sm'>Edit</a>"; ?>
                            </td>
                          </tr>
                        <?php } ?>
                      </tbody>
