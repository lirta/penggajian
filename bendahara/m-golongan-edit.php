                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-danger">
                                        <div class="card-header">
                                            <h3 class="card-title">Input Data Master Golongan</h3>
                                        </div>
                                        <div class="card-body">
                                            <!-- Date dd/mm/yyyy -->

                                            <?php $qedit = mysqli_query($koneksi, "SELECT * FROM master_golongan where id_m_golongan='$_GET[id]'");
                                            $edit = mysqli_fetch_assoc($qedit); ?>
                                            <form role="form" action="m-golongan-edit-proses.php" method="post" enctype="multipart/form-data">
                                                <div class="col-md-4">
                                                    <div class="form-group" hidden>
                                                        <label>id</label>
                                                        <input type="text" class="form-control" name="id" value="<?php echo "$edit[id_m_golongan]"; ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Golongan</label>
                                                        <input type="text" class="form-control" value="<?php echo "$edit[golongan]"; ?>" disabled>
                                                    </div>
                                                    <div class="form-group">
