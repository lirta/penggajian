                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-danger">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form role="form" action="golongan-add-proses.php" method="post" enctype="multipart/form-data">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="custom-select" name="guru">
                                                            ...
                                                            while ($hasil = mysqli_fetch_assoc($query)) {
                                                                $qgl = mysqli_query($koneksi, "SELECT * FROM golongan where id_pegawai='$hasil[id_pegawai]' ");
                                                                $r = mysqli_num_rows($qgl);
                                                                if ($r > 0) {
                                                                } else {
                                                                    echo "<option value='$hasil[id_pegawai]'>$hasil[nama_pegawai] || $hasil[kategori]</option>";
                                                                }
                                                            } ?>
                                                        </select>
                                                    </div>
